...
const reviews = [
  {
    name: "יוסי כהן",
    content: "האתר ממש עזר לי להבין הסתברות, קיבלתי 95 בבגרות!",
  },
  {
    name: "דנה לוי",
    content: "ההסברים היו ברורים מאוד, ממליצה לכל מי שלומד מתמטיקה.",
  },
  {
    name: "אייל שמעוני",
    content: "תודה רבה! סוף סוף הבנתי מה זה אינדוקציה מתמטית.",
  },
  { name: "נופר אזולאי", content: "שיעורים מעולים, קל להבין את החומר!" },
  { name: "רועי מלכה", content: "האתר הציל אותי לפני מבחן, תודה!" },
  {
    name: "מיכל רוזן",
    content: "אהבתי מאוד את הדרך שבה מוסבר החומר, ממש ברור.",
  },
  {
    name: "אור בן דוד",
    content: "התרגולים באתר מעולים, עזר לי לשפר את הציונים.",
  },
  ...
  {
    name: "יונתן ברק",
    content: "האתר מלא בתוכן איכותי, שווה כל רגע של למידה.",
  },
...
const ReviewsTable = () => {
  ...
  const maxScroll = reviews.length * 50 - 300; // Approximate max scroll position

  useEffect(() => {
    const scrollInterval = setInterval(() => {
      if (tableRef.current) {
        // Increase scroll position slowly
  ...
  return (
    <div
      className="bg-white rounded-lg shadow-lg p-6 max-w-xl mx-auto"
      dir="rtl"
    >
      ...
      <div
        ref={tableRef}
        className="max-h-96 overflow-hidden border border-gray-200 rounded-lg"
      >
